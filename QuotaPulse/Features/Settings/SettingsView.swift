        ...
        Form {
            ...
            Section("Display") {
                ...
                if model.pinnedProviderRawValue != nil, model.pinnedProviderID == nil {
                    Text("The selected menu bar provider is unavailable in this version of QuotaPulse.")
                        .font(.caption)
    ...
    var body: some View {
        Form {
            Section("Providers") {
                ...
                Text("Claude Code remains Experimental and Unverified. QuotaPulse does not install or configure its bridge.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
                    .fixedSize(horizontal: false, vertical: true)
            }
