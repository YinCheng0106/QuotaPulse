...
See the [README](../main/README.md) for build-from-source instructions and the complete privacy and compatibility notes.
...
請參閱 [README.zh-TW](../main/README.zh-TW.md)，以取得從原始碼建置的說明，以及完整的隱私與相容性注意事項。
